...
// Where to go back — default to student-dashboard.php
$from = $_GET['from'] ?? 'student-dashboard.php';
// Whitelist allowed pages only for security
...
<nav class="lesson-nav">
    <a href="<?php echo htmlspecialchars($from); ?>" class="lnav-back">
...
function openEditModal() {
    document.getElementById('editIframe').src = 'edit-profile.php?from=<?php echo urlencode($from); ?>';
